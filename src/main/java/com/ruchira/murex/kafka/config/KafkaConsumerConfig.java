...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MurexTradeOutBound> concurrentKafkaListenerContainerFactory(
            ConsumerFactory<String, MurexTradeOutBound> consumerFactory
    ) {
        ConcurrentKafkaListenerContainerFactory<String, MurexTradeOutBound> factory =
